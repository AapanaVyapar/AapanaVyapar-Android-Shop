            ...
            public void onClick(View v) {
                ...
                CreateShopRequest request = CreateShopRequest.newBuilder()
                        ...
                        .setOperationalHours(OperationalHours.newBuilder()
                                .addAllSunday(Arrays.asList("8:00AM", "10:00PM"))
                                .addAllMonday(Arrays.asList("8:00AM", "10:00PM"))
                                .addAllTuesday(Arrays.asList("8:00AM", "10:00PM"))
                                .addAllWednesday(Arrays.asList("8:00AM", "10:00PM"))
                                .addAllThursday(Arrays.asList("8:00AM", "10:00PM"))
                                .addAllFriday(Arrays.asList("8:00AM", "10:00PM"))
                                .addAllSaturday(Arrays.asList("8:00AM", "10:00PM"))
                                .build())
                        .build();
                try {
